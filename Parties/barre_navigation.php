...
<div class="recherche">
  <form method="post" action="results.php">
    <input type="search" name="recherche" id="site-search" size="35" placeholder="Cherchez un utilisateur, un admin, etc..."  required>
...
<div class="navigation">
  <ul>
    ...
    <li><a title="<?php echo $_SESSION['user'];?>" href="profil.php"> <?php echo $_SESSION['user'];?> </a></li>
    <li><a title="parametres.php" href=""> Parametres </a></li>
  </ul>
</div>
