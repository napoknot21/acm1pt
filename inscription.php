        ...
        <form action="traitement_inscription.php" method="post">
            <div class="formulaire">
                <div class="form-group">
                    <input type="text" autocapitalize="word" size="45" name="name" placeholder="Prénom" required>
                </div>
                <div class="form-group">
                    <p><input type="text" autocapitalize="word" size="45" name="lastName" placeholder="Nom" required></p>
                </div>
                <div class="form-group">
                    <p><input type="text" name="pseudo" size="45" placeholder="Utilisateur" required></p>
                </div>
                <div class="form-group">
                    <p><input type="email" name="email" size="45" placeholder="Adresse email" require></p>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <p><input type="password" name="password" size="45" placeholder="Mot de Passe" value="" required></p>
                </div>
                <div class="form-group">
                    <p><input type="password" name="repPassword" size="45" placeholder="Confirmer"value="" required></p>
                </div>
                <div class="form-group">
